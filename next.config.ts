...
// Content Security Policy — restrictive but allows analytics + Pexels images.
// 'unsafe-inline' on script-src needed for Next.js SSR-hydration. Tighten via
// middleware + nonce when going to maximum security.
const cspDirectives = [
  "default-src 'self'",

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    { path: '/werkstatt', changeFrequency: 'monthly' as const, priority: 0.8 },
    { path: '/werkstatt/wartung', changeFrequency: 'monthly' as const, priority: 0.7 },
    { path: '/werkstatt/reparatur', changeFrequency: 'monthly' as const, priority: 0.7 },
    { path: '/werkstatt/klassiker', changeFrequency: 'monthly' as const, priority: 0.7 },
    { path: '/werkstatt/aufbereitung', changeFrequency: 'monthly' as const, priority: 0.7 },
